...
import sceneSound from "/assets/sounds/Scenes C2/C2_1.mp3";
...
const Bedroom = () => {
  ...
  const sceneAudioRef = useRef(new Audio(sceneSound));
  ...
  const handleBedClick = () => {
    // Reproducir el audio de la cama al hacer clic
    // Aquí debes agregar la lógica para reproducir el sonido C2_1.mp3
    console.log("Cama clickeada");
    // Puedes llamar a la función playSceneSound() para reproducir el sonido si es necesario.
  };


  const playSceneSound = () => {
    sceneAudioRef.current.currentTime = 0; // Reinicia la reproducción al principio
  ...
  useEffect(() => {
    // Ejemplo: Iniciar la reproducción del sonido después de 6 segundos.
